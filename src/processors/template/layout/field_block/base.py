...
from src.processors.template.layout.field.barcode_field import BarcodeField
from src.processors.template.layout.field.bubble_field import BubbleField
from src.processors.template.layout.field.ocr_field import OCRField
from src.processors.template.layout.field_block.field_block_drawing import (
    FieldBlockDrawing,
)
from src.utils.parsing import default_dump, parse_fields

if TYPE_CHECKING:
    from src.processors.template.layout.field.base import Field, ScanBox
