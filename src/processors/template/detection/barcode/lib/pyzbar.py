...
from src.processors.template.detection.barcode.lib.text_barcode import TextBarcode
from src.processors.template.detection.base.detection import TextDetection
