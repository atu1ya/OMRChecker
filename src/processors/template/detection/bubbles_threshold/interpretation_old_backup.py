...
from src.processors.template.detection.base.interpretation import FieldInterpretation
from src.processors.template.detection.bubbles_threshold.bubble_interpretation import (
    BubbleInterpretation,
)
from src.processors.template.detection.bubbles_threshold.detection import (
    BubbleMeanValue,
)
from src.processors.template.detection.bubbles_threshold.interpretation_drawing import (
