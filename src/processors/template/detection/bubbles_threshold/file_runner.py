...
from src.processors.template.detection.bubbles_threshold.detection_pass import (
    BubblesThresholdDetectionPass,
)
from src.processors.template.detection.bubbles_threshold.interpretation_pass import (
